...
# Dynamic maintainer resolution if defined late in device makefile or BoardConfig
ifndef XEPHIRA_MAINTAINER
    XEPHIRA_MAINTAINER := $(LINEAGE_MAINTAINER)
endif
ifeq ($(XEPHIRA_MAINTAINER),UNKNOWN)
    ifneq ($(strip $(LINEAGE_MAINTAINER)),)
        XEPHIRA_MAINTAINER := $(LINEAGE_MAINTAINER)
    else ifneq ($(strip $(DEVICE_MAINTAINER)),)
        XEPHIRA_MAINTAINER := $(DEVICE_MAINTAINER)
    else ifneq ($(strip $(PRODUCT_MAINTAINER)),)
        XEPHIRA_MAINTAINER := $(PRODUCT_MAINTAINER)
    else ifneq ($(strip $(TARGET_MAINTAINER)),)
        XEPHIRA_MAINTAINER := $(TARGET_MAINTAINER)
    else ifneq ($(strip $(MAINTAINER)),)
